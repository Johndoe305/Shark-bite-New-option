-- SEU SCRIPT ORIGINAL (Hitbox Shark)
local player = game.Players.LocalPlayer
local gui = Instance.new("ScreenGui", player:WaitForChild("PlayerGui"))
gui.Name = "HitboxGuiV3"

local frame = Instance.new("Frame", gui)
frame.Size = UDim2.new(0, 220, 0, 270) -- aumentei altura para caber o botão Anti-Cheat
...
antiButton.Position = UDim2.new(0.05, 0, 0, 155) -- logo abaixo do ESP
...
inputBox.Position = UDim2.new(0.05, 0, 0, 195) -- abaixo do Anti-Cheat
